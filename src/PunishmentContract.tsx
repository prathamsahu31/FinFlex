...
import { ShieldAlert, Gavel, Coins, Target } from 'lucide-react';
      ...
      <div className="p-4 lg:p-8 max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <div className="border-t-4 border-white pt-8">
            ...
            <div className="w-32 h-32 border-4 border-gumroad-pink mx-auto flex items-center justify-center rotate-12">
