...
const INITIAL_MESSAGES = [
  {
    id: 1,
    sender: 'bot',
    text: "Yo! I'm your OpenClaw AI. Ready to secure the bag? ð°",
    timestamp: '10:00 AM'
  },
  {
    id: 2,
    sender: 'bot',
    text: "Vibe check: you spent $15 on coffee today. Swept $1.50 into your Algo-Save. That's giving future millionaire energy. â¨",
    timestamp: '10:01 AM'
  }
];
      ...
      <div className="mb-6 shrink-0 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
            OpenClaw AI <Sparkles size={18} className="text-amber-500" />
          </h1>
