...
import { Calculator, Target, Repeat, DollarSign, X, CreditCard, PieChart } from 'lucide-react';
...
function SubscriptionsTracker() {
  const subs = [
    { name: 'Netflix', price: 15.49, cycle: 'Monthly' },
    { name: 'Spotify', price: 10.99, cycle: 'Monthly' },
    { name: 'Gym Membership', price: 45.00, cycle: 'Monthly' },
    { name: 'Amazon Prime', price: 14.99, cycle: 'Monthly' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {subs.map((sub, i) => (
          <div key={i} className="flex justify-between items-center p-3 border border-slate-100 rounded-xl bg-slate-50">
            <div>
